...
Bullet::Bullet(int id, int idType, float PosX, float PosY, sf::Image *image) : Entity(id, idType, PosX, PosY, image)
{
...
void Bullet::updateAnim(float i)
{
...
{
	std::cout << "Je suis un Bullet" << std::endl;
}
